...
},{"./views/addSong":162,"./views/songList":164,"react":159,"react-dom":3}],161:[function(require,module,exports){
...
},{"firebase":1}],162:[function(require,module,exports){
...
},{"firebase":1,"react":159}],163:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    var songs = this.state.songs.map(function (song, i) {
      return (
        React.createElement(Song, React.__spread({},  song, {key: i}))
      );
    });
...
},{"./song":163,"firebase":1,"react":159}]},{},[160,161,162,163,164])